...
# Blokada bloku otrzymania nakazu  

1. Wpis w E-1758 i zgłoszenie

Podczas odblokowywania się bloku otrzymania nakazu A<sup>1</sup> dla przygotowania wjazdu pociągu nr 12345, blok nie odblokował się w pełni - zatrzymał się w położeniu połowicznym. Nie można go zablokować, ani przełożyć drążka przebiegowego a<sup>1</sup>.

- Nastawniczy powiadamia dyżurnego ruchu, usterkę odnotowuje w E-1758 i książce przebiegów.
- Dyżurny ruchu zapisuje w E-1758.
- Dyżurny ruchu powiadamia automatyków.

2. Wprowadzenie obostrzeń

- Dyżurny ruchu wprowadza stosowne obostrzenia

Wprowadzam telefoniczne zapowiadanie pociągów po torze nr 1 pomiędzy Białą i Dubnem z powodu awarii blokady stacyjnej.

Wprowadzam telefoniczne polecanie i zgłaszanie przygotowania dróg przebiegu pomiędzy Du i Du1 dla pociągów wjeżdżających po torze nr 1 od Białej do Dubna.

3. Zezwalam na użycie przełącznika awaryjnej aktywacji zastawki nad blokiem końcowym KoA<sup>1/2</sup>. 

4. Po awarii bloku otrzymania nakazu A<sup>1</sup> mimo dźwięku pracy urządzeń nie wyświetla się ani nie działa nakaz wyświetlenia sygnału zastępczego OnSzA.

5. Wjazd pociągu nr 12345 odbył się na rozkaz pisemny RD-123-123456-26

6. Po wjeździe pociągu nr 12345 mimo użycia przełącznika awaryjnej aktywacji zastawki, zastawka nad blokiem końcowym KoA<sup>1/2</sup> nie zwolniła i nie można zablokować bloku końcowego.
...
<tr>
  ...
  <tr>
     <td colspan="22" style="text-align: center;">Nadał dyżurny ruchu Kowalski, odebrał nast. Malinowski, godz. 2<sup>40</sup>.</td>
  
  </tr>
  <tr>
    <td>4422</td><!-- nr pociągu -->
    <td>Cz</td><!-- z -->
    <td>2</td><!-- na tor -->
    ...
    <td>3</td><!-- p. wjechał godz. -->
    <td>51</td><!-- p. wjechał min.-->
     <td style="border-right: 3px double;"></td><!-- uwagi -->
    <td>1461</td><!-- nr pociągu -->
    <td>Cz</td><!-- do -->
    <td>3</td><!-- z toru -->
    <td></td><!-- wyjazd przygotowany w okręgu-->
    <td>2</td><!-- wyjazd przygotowany godz.-->
    <td>55</td><!-- wyjazd przygotowany min.-->
    <td>-</td><!-- dać sygn. zezw. wyj. godz.-->
    <td>-</td><!-- dać sygn. zezw. wyj. min.-->
    <td>2</td><!-- p. wyjechał godz. -->
    <td>58</td><!-- p. wyjechał min.-->
     <td>może wyjechać g. 2<sup>56</sup><br>dr. przeb. z 2/3</td><!-- uwagi -->
    </tr>
    <tr>
      <td>7466</td><!-- nr pociągu -->
      <td>Cz</td><!-- z -->
      <td>2</td><!-- na tor -->
      <td></td><!-- wjazd przygotowany w okręgu-->
      <td></td><!-- wjazd przygotowany godz.-->
      ...
      <td>46</td><!-- p. wjechał min.-->
      <td style="border-right: 3px double;"></td><!-- uwagi -->
      <td>1463</td><!-- nr pociągu -->
      <td>Cz</td><!-- do -->
      <td>1</td><!-- z toru -->
      <td></td><!-- wyjazd przygotowany w okręgu-->
      <td>3</td><!-- wyjazd przygotowany godz.-->
      <td>07</td><!-- wyjazd przygotowany min.-->
      <td>-</td><!-- dać sygn. zezw. wyj. godz.-->
      <td>-</td><!-- dać sygn. zezw. wyj. min.-->
    ...
    <tr>
      ...
      <td></td><!-- wyjazd przygotowany w okręgu-->
      <td>3</td><!-- wyjazd przygotowany godz.-->
      <td>37</td><!-- wyjazd przygotowany min.-->
      <td>-</td><!-- dać sygn. zezw. wyj. godz.-->
      <td>-</td><!-- dać sygn. zezw. wyj. min.-->
      <td>3</td><!-- p. wyjechał godz. -->
